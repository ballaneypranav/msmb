...
source("../chapter-setup.R"); chaptersetup("/__w/CUBook/CUBook/Chap3-Graphics/rgraphics.Rnw", "3")
...
knitr::include_graphics(c('images/Automatisches_Zeichengeraet_ZUSE_Z64_ubt.JPG'), dpi = NA)
...
knitr::include_graphics(c('images/Yusukecells-2.jpg'), dpi = NA)
...
knitr::include_graphics(c('images/Lawrence-TCGA-Nature-2013-Fig1.png'), dpi = NA)
...
knitr::include_graphics(c('images/chap3-rglvolcano.png'), dpi = NA)
...
knitr::include_graphics(c('images/chap3-ecdfs-bauhaus93font.png'), dpi = NA)
...
knitr::include_graphics(c('images/EBI-genomebrowser-rnaseq.png'), dpi = NA)
...
knitr::include_graphics(c('images/xkcdgraph.png'), dpi = NA)
