...
source("../chapter-setup.R"); chaptersetup("/__w/CUBook/CUBook/Chap2-Stat/FreqandBayesandModels.Rnw", "2")
...
knitr::include_graphics(c('images/StatDiagram.png'), dpi = NA)




## ---- Parameters, eval = TRUE, echo = FALSE, fig.show = 'hold', fig.keep = 'high'----
knitr::include_graphics(c('images/Parameters.png'), dpi = NA)
...
knitr::include_graphics(c('images/ProbaDiagram.png'), dpi = NA)
...
knitr::include_graphics(c('images/ChargaffColdSpring.png'), dpi = NA)
...
knitr::include_graphics(c('images/turtlesalltheway.png'), dpi = NA)
...
knitr::include_graphics(c('images/STRDefinition.png'), dpi = NA)
...
knitr::include_graphics(c('images/DESeq2-Prediction-Interval.png'), dpi = NA)
