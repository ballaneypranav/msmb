...
source("../chapter-setup.R"); chaptersetup("/__w/CUBook/CUBook/Chap1-Prob/Generative.Rnw", "1")
...
knitr::include_graphics(c('images/Pile_ou_face.png'), dpi = NA)
...
knitr::include_graphics(c('images/BallsinBoxes2.jpg'), dpi = NA)
...
knitr::include_graphics(c('images/Simeon_Poisson.png'), dpi = NA)
...
knitr::include_graphics(c('images/Antibody_IgG2.png'), dpi = NA)
...
knitr::include_graphics(c('images/BallsinBoxes4.jpg'), dpi = NA)
...
knitr::include_graphics(c('images/SampleSize.png'), dpi = NA)
